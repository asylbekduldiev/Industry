...
const Footer = () => {
    return (
      <footer className="bg-[#0D0D3A] text-[#D3D3F5] p-14">
        <div className="max-w-screen-7xl flex flex-wrap justify-between gap-10">
          <div className="flex-1 min-w-[250px]">
            ...
            <div className="mt-4 flex gap-2">
              <input
                ...
                className="px-4 py-2 rounded-md bg-[#282873] text-white flex-1"
              />
              <button className="px-4 py-2 bg-purple-400 text-white rounded-md">Subscribe</button>
            </div>
          </div>
